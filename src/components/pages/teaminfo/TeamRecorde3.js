      ...
      <Table className={classes.table}>
        <TableHead>
          <TableRow>
            ...
            <CustomTableCell numeric>플레이 타임</CustomTableCell>
            <CustomTableCell numeric>필드슛 성공</CustomTableCell>
            <CustomTableCell numeric>필드슛 시도</CustomTableCell>
            <CustomTableCell numeric>필드슛 성공률</CustomTableCell>
            <CustomTableCell numeric>3점슛 성공</CustomTableCell>
            <CustomTableCell numeric>3점슛 시도</CustomTableCell>
            <CustomTableCell numeric>3점슛 성공률</CustomTableCell>
            <CustomTableCell numeric>야투 성공률</CustomTableCell>
            <CustomTableCell numeric>자유투 성공</CustomTableCell>
            <CustomTableCell numeric>자유투 시도</CustomTableCell>
